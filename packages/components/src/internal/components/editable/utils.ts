...
export function genCellKey(fieldKey: string, rowIdx: number, sampleFieldKeyPrefix?: string): string {
    return (sampleFieldKeyPrefix ? sampleFieldKeyPrefix.toLowerCase() + '/' : '') + genCellKeyPrefix(fieldKey) + rowIdx;
}
